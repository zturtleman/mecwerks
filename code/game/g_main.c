...
#ifdef MEC_DEBUG
	{ &m_devcmd[0], "m_nospawnwp", "0", CVAR_ARCHIVE, 0, qfalse},
	{ &m_devcmd[1], "m_nospawnit", "0", CVAR_ARCHIVE, 0, qfalse},
	{ &m_devcmd[2], "m_nospawnam", "0", CVAR_ARCHIVE, 0, qfalse},
	{ &m_devcmd[3], "m_nospawnall", "0", CVAR_ARCHIVE, 0, qfalse},
#endif
...
void CheckExitRules( void ) {
	...
	if ( g_gametype.integer < GT_CTF && g_fraglimit.integer && g_gametype.integer != GT_FRENZY && g_gametype.integer != GT_TEAM_FRENZY && g_gametype.integer != GT_RARENA ) {
