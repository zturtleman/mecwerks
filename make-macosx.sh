...
BINARY=mecwerks.${BUILDARCH}
DEDBIN=mecwerks-server.${BUILDARCH}
PKGINFO=APPLIOQ3
...
BIN_OBJ="
	build/release-darwin-x86_64/mecwerks.${BUILDARCH}
"
BIN_DEDOBJ="
	build/release-darwin-x86_64/mecwerks-server.${BUILDARCH}
"
BASE_OBJ="
	build/release-darwin-x86_64/$BASEDIR/cgame${BUILDARCH}.dylib
	build/release-darwin-x86_64/$BASEDIR/ui${BUILDARCH}.dylib
	build/release-darwin-x86_64/$BASEDIR/game${BUILDARCH}.dylib
"
MPACK_OBJ="
	build/release-darwin-x86_64/$MPACKDIR/cgame${BUILDARCH}.dylib
	build/release-darwin-x86_64/$MPACKDIR/ui${BUILDARCH}.dylib
	build/release-darwin-x86_64/$MPACKDIR/game${BUILDARCH}.dylib
"
RENDER_OBJ="
	build/release-darwin-x86_64/renderer_opengl1_smp_${BUILDARCH}.dylib
	build/release-darwin-x86_64/renderer_opengl1_${BUILDARCH}.dylib
	build/release-darwin-x86_64/renderer_rend2_smp_${BUILDARCH}.dylib
	build/release-darwin-x86_64/renderer_rend2_${BUILDARCH}.dylib
"
...
if [ -d /Developer/SDKs/MacOSX10.5.sdk ]; then
	...
	ARCH_CFLAGS="-arch x86_64 -isysroot /Developer/SDKs/MacOSX10.5.sdk \
